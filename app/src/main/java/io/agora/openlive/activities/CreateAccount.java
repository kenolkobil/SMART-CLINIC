...
import io.agora.openlive.models.Doctor;
import io.agora.openlive.models.Patient;

public class CreateAccount extends AppCompatActivity {
    //Doctor fields
    LinearLayout doctorLinearLayout;
    RadioButton doctorRadioButton;
    EditText doctorFullName, doctorCode, doctorPhoneNumber, doctorEmail, doctorCity, doctorAddress, doctorPassword1, doctorPassword2;
    Spinner doctorSpeciality;
    Button doctorButton;
    // Patient fields
    LinearLayout patientLinearLayout;
    RadioButton patientRadioButton;
    EditText patientFirstName, patientLastName, patientBirthDate, patientPhoneNumber, patientEmail, patientCIN, patientbloodgroup,patientpasthistory, patientPassword1, patientPassword2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patientpasthistory=findViewById(R.id.patientpasthistory);
        ...
        doctorSpeciality = (Spinner) findViewById(R.id.speciality_spinner);
        ArrayAdapter<CharSequence> adapter1= ArrayAdapter.createFromResource(this, R.array.speciality_dropdown, android.R.layout.simple_spinner_dropdown_item);
        adapter1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        doctorSpeciality.setAdapter(adapter1);
    ...
    public void registerPatient() {
        ...
        final String bloodgroup=patientbloodgroup.getText().toString().trim();
        final String pasthistory=patientpasthistory.getText().toString().trim();
            ...
            fbAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        Patient patient = new Patient(firstName, lastName, birthDate, phoneNumber, email, CIN, status, bloodgroup, pasthistory);
    ...
    private void registerDoctor() {
        ...
        final String Speciality = doctorSpeciality.getSelectedItem().toString().trim();;
