...
public class PatientProfileInformations extends AppCompatActivity {
    TextView fullName, cin, email, phoneNumber, maritalStatus, birthDate,bloodgroup,pasthistory;
    CircleImageView circleImageView;
    FirebaseUser user;
    String uid;
    String Uri;
    DatabaseReference databaseReference;
    String firstNameRetrieved, lastNameRetrieved, cinRetrieved, emailRetrieved, phoneNumberRetrieved, maritalStatusRetrieved, birthdateRetrieved, bloodgroupretrieved, pasthistoryretrieved ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                bloodgroupretrieved = dataSnapshot.child(uid).child("bloodgroup").getValue(String.class);
                if(bloodgroupretrieved==null){
                    bloodgroup.setText("Unspecified");
                }
                else bloodgroup.setText(bloodgroupretrieved);

                pasthistoryretrieved = dataSnapshot.child(uid).child("pasthistory").getValue(String.class);
                if(pasthistoryretrieved==null){
                    pasthistory.setText("None");
                }
                else pasthistory.setText(pasthistoryretrieved);
    ...
    private void startRevealActivity(View v) {
        ...
        intent.putExtra("bloodgroup", bloodgroupretrieved);
        intent.putExtra("pasthistory", pasthistoryretrieved);
