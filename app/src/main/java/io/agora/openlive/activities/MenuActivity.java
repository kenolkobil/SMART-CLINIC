...
import io.agora.openlive.models.Appointment;
...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        streamd=findViewById(R.id.stream);
        streamd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),Mainvedio.class));
            }
        });
    ...
    public void Feedback(View view){
        ...
        sweetAlertDialog.setContentText("Mwangangi is developing the stuff... Thank you!");
