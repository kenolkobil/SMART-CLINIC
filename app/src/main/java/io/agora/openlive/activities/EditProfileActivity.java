...
public class EditProfileActivity extends AppCompatActivity {
    ...
    EditText fullName, cin, email, phoneNumber, birthDate, maritalStatus,bloodgroup,pasthistory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bloodgroup.setText(receivedbloodgroup);
        pasthistory.setText(receivedpasthistory);
        if(uri!=null){
    ...
    public void update(View view) {
        ...
        final Patient patient = new Patient(fn[0],fn[1],birthDate.getText().toString(),phoneNumber.getText().toString(),email.getText().toString()
                ,cin.getText().toString(),maritalStatus.getText().toString(),bloodgroup.getText().toString(),pasthistory.getText().toString());
